    ...
    <div class="container">
                ...
                <form class="form-group" method="GET" action="{{ route('home') }}">
                    <div class="position-form">
                        <a href="{{
                           ...
                           <i class="fa fa-chevron-left arrow-left" aria-hidden="true"></i>
                        </a>
        ...
        @foreach($blockedDates as $blockedDate)
            @if (!empty($blockedDate))
                <p class="text-center text-information">
            ...
            @foreach ($auditoria as $aud)
                <div class="col-md-4 col-lg-4">
                    <div class="well well-principal">
                        <div class="row">
                            <span class="col-md-10 col-lg-10 text-center aud-name">
                                {{ $aud->name}}
                            </span>

                            <a id="down"
                               class="col-md-2 col-lg-2 icone-down"
                               role="button" 
                               data-toggle="collapse"
                               href="#collapse{{ $aud->id }}"
                               aria-expanded="false"
                        ...
                        <div class="well well-collapse">
                            ...
                            @if ($aud->accessible)
                                <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12">
                                    <p class="accessible">
                                        <i class="fa fa-wheelchair style-icons"
                                           aria-hidden="true"
                                           data-toggle="tooltip"
                                           data-placement="bottom"
                                           title="Cadeirante"></i>
                                        <i class="fa fa-blind style-icons"
                                           aria-hidden="true"
                                           data-toggle="tooltip"
                                           data-placement="bottom"
                                           title="Deficiente Visual"></i>
                                        <i class="fa fa-universal-access style-icons"
                                           aria-hidden="true"
                                           data-toggle="tooltip"
                                           data-placement="bottom"
                                           title="Acesso Universal"></i>
                                    </p>
                                </div>
                            @endif
                        </div>
...
@section('sources')
    ...
    <script type="text/javascript" src="{{ asset('js/jquery-script-icons-auditorium-index.js') }}">
    </script>
